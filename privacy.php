		...
		<div class="container mt-100">
			<div class="card shadow border-0">
				<div class="card-body">
					...
					<p class="card-text">ウサミン星（以下「当サイト」といいます）では、お問い合わせフォームや当サイトにより提供されるサービス（以下「本サービス」といいます）の利用などの際に、本サービスをご利用になる方（以下「利用者」といいます）のお名前、メールアドレス等の個人情報をご入力いただく場合がございます。</p>
					...
					<h5 class="card-text">プライバシーポリシーの改訂について</h5>
					<p class="card-text">本プライバシーポリシーは、適宜行われる見直しにより改訂される場合がございます。</p>
					<p class="card-text">尚、改訂後の最新のプライバシーポリシーは本ページにて公開されます。</p>
